...
function shuffleArray(array) {
    let curretIndex = array.length, temporaryValue, randomIndex;

    while (0 !== curretIndex) {
        randomIndex = Math.floor(Math.random() * curretIndex);
        curretIndex -= 1;

        temporaryValue = array [curretIndex];
        array[curretIndex] = array[randomIndex];
